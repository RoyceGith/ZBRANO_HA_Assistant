...
with selected-position insertion and automatic focus on the exact new settings. The full Advanced editor remains available, existing stored automations are preserved, and
